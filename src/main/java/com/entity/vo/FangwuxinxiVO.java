...
public class FangwuxinxiVO  implements Serializable {
	...
	public void setFangyuansheshi(String fangyuansheshi) {
		this.fangyuansheshi = fangyuansheshi;
	}
	
	/**
	 * 获取：房源设施
	 */
	public String getFangyuansheshi() {
		return fangyuansheshi;
	}
