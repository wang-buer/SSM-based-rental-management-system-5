						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="baoxiuriqi" name="baoxiuriqi" class="form-control" v-model="ruleForm.baoxiuriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>账号</label>
									...
									<div class="form-group  col-md-12">
										<label>问题简述</label>
										<script id="wentijianshuEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.wentijianshu != null && ruleForm.wentijianshu != 'null' && ruleForm.wentijianshu != ''){
				var mes = '' + ruleForm.wentijianshu;
				var wentijianshuUeditor = UE.getEditor('wentijianshuEditor');
				wentijianshuUeditor.ready(function() {
					wentijianshuUeditor.setContent(mes);
					wentijianshuUeditor.setDisabled('fullscreen');
				});
			}
