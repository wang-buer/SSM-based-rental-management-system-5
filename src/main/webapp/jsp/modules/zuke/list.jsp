...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>租客列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">租客列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										账号
									</label>
									<input type="text" id="zhanghaoSearch" class="form-control form-control-sm" placeholder="请输入账号" aria-controls="tableId">
									<label>
										姓名
									</label>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			zhaopianImg.setAttribute('src',baseUrl+item.zhaopian);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zuke/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zuke");
