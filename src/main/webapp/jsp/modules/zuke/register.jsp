...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210416/9d1a6ec590c54e42b75e08d653fb42e2.jpeg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		background-color: rgba(222, 190, 133, 0.8);
	...
	#registerForm button.pull-right {
		...
		border-style: solid;
		border-color: #ccc;
		background-color: rgba(0, 186, 189, 0.8);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
	}
