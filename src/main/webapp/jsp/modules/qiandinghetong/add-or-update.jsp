...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑签订合同</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>签订合同管理</span></li>
								<li class="breadcrumb-item active"><span>编辑签订合同</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">签订合同信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>合同编号</label>
										<input id="hetongbianhao" name="hetongbianhao" class="form-control" value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>标题</label>
									...
									<div class="form-group col-md-6">
										<label>文件</label>
										<div>
										<div class="upload">选择文件<input name="file" type="file" class="form-control-file" id="wenjianupload"></div>
									...
									<div class="form-group col-md-6">
										<label>签订日期</label>
										<div id="qiandingriqiDate" class="input-append date form_datetime">
											<input id="qiandingriqi-input" name="qiandingriqi" size="15" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>有效期</label>
										<input name="youxiaoqi" id="youxiaoqi" name="youxiaoqi" class="form-control" placeholder="有效期">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
									...
									<div class="form-group col-md-6">
										...
										<input name="shenfenzheng" id="shenfenzheng" name="shenfenzheng" class="form-control" placeholder="身份证">
											...
											<div class="form-group  col-md-12" >
												...
												<script id="neirongEditor" type="text/plain"></script>
	...
	<script>
		...
		function hetongbianhaoUuid(){
			if($("#hetongbianhao").val() == null || $("#hetongbianhao").val() == "null" || $("#hetongbianhao").val() == ""){
				$("#hetongbianhao").attr("value",Math.round(new Date().getTime()/1000));
			}
		}				
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "qiandinghetong/info/" + id,
		...
		function upload(){
			...
			$('#wenjianupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('wenjian-input').setAttribute('value','file/download?fileName='+data.result.file);
				...
				if(crossrefid && crossuserid) {
					...
					http("qiandinghetong/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("qiandinghetong/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getContent(){
			if(UE.getEditor('neirongEditor').hasContents()){
				$('#neirong-input').attr('value',UE.getEditor('neirongEditor').getContent());
			}
		}
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("qiandinghetong/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#qiandingriqi-input").val(getCurDate());
			$("#qiandingriqiDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculationSE(colName){
			//单列求和接口
			http("qiandinghetong"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#hetongbianhao").val(ruleForm.hetongbianhao);	
			...
			$("#qiandingriqi-input").val(ruleForm.qiandingriqi);
			$("#youxiaoqi").val(ruleForm.youxiaoqi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.hetongbianhao != null && res.data.hetongbianhao != ''){

						$("#hetongbianhao").val(res.data.hetongbianhao);
						$("#hetongbianhao").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.neirong != null && res.data.neirong != ''){
                        ...
                        var neirongMes = '' + res.data.neirong;
                        var neirongUeditor = UE.getEditor('neirongEditor');
                        neirongUeditor.ready(function() {
                            neirongUeditor.setContent(neirongMes);
                        });
					...
					if(res.data != null && res.data != '' && res.data.qiandingriqi != null && res.data.qiandingriqi != ''){

						$("#qiandingriqi-input").val(res.data.qiandingriqi);
						$('#qiandingriqiFileName').val(res.data.qiandingriqi)
					}
					if(res.data != null && res.data != '' && res.data.youxiaoqi != null && res.data.youxiaoqi != ''){

						$("#youxiaoqi").val(res.data.youxiaoqi);
						$("#youxiaoqi").attr('readonly','readonly');
					}
