...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="hetongbianhao" name="hetongbianhao" class="form-control" v-model="ruleForm.hetongbianhao" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>标题</label>
									...
									<button class="btn-upload" id="wenjian">点击下载</button>
									</div>
									<div class="form-group col-md-6">
									<label>签订日期</label>

									<input id="qiandingriqi" name="qiandingriqi" class="form-control" v-model="ruleForm.qiandingriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>有效期</label>

									<input id="youxiaoqi" name="youxiaoqi" class="form-control" v-model="ruleForm.youxiaoqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>账号</label>
	...
	<script>
		...
		function setDownloadBtn(){
			var wenjianUrl = "download('" + ruleForm.wenjian + "')";
			$("#wenjian").attr("onclick",wenjianUrl);
		}			
		//设置音视频播放链接
