...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">签订合同管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>签订合同列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">签订合同列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('youxiaoqi')">有效期<i id="youxiaoqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var wenjianCell  = document.createElement('td');

						  var wenjianFile = document.createElement('button');
			  wenjianFile.setAttribute('class','btn-table')
			  wenjianFile.innerHTML = '下载';
			  var wenjianFileAttr = "download('" +baseUrl+ item.wenjian + "')"
			  wenjianFile.setAttribute('onclick',wenjianFileAttr);
        	          wenjianCell.appendChild(wenjianFile);


			row.appendChild(wenjianCell);
			...
			var youxiaoqiCell  = document.createElement('td');

						 youxiaoqiCell.innerHTML = item.youxiaoqi;

			row.appendChild(youxiaoqiCell);
		...
		function sh(){
			...
			httpJson("qiandinghetong/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qiandinghetong/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"qiandinghetong");
